# Claude Instructions for homelab-auth
...
- **Name**: homelab-auth
- **Package**: homelab_auth
- **Description**: Home Lab Auth
- **Organization**: MrSecure (home.arpa)
- **Python Version**: 3.11+
...
```
homelab_auth/    # Main package code
...
### Error Handling
```python
class HomelabAuthError(Exception):
    """Base exception for homelab-auth."""
    pass

class ConfigurationError(HomelabAuthError):
...
4. Follow MrSecure coding standards
